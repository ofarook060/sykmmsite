...
<head>
    ...
    <style>
        ...
        header { background: #fff; box-shadow: 0 2px 5px rgba(0,0,0,0.05); padding: 15px 5%; display: flex; justify-content: space-between; align-items: center; }
        ...
        .hero { background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('') no-repeat center center/cover; padding: 80px 20px; text-align: center; color: white; }
        .hero h1 { margin-0; font-size: 2.5rem; }

        .search-container { max-width: 800px; margin: -30px auto 40px auto; background: white; padding: 20px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); }
        .search-form { display: flex; gap: 15px; flex-wrap: wrap; }
        .search-form input { flex: 1; padding: 12px; border: 1px solid #ddd; border-radius: 4px; font-size: 1rem; min-width: 200px; }
        .search-form button { padding: 12px 25px; background: #007bff; color: white; border: none; border-radius: 4px; font-size: 1rem; cursor: pointer; font-weight: bold; }
        ...
        .card-title { font-size: 1.25rem; margin: 0 0 10px 0; color: #222; }
        .card-price { font-size: 1.4rem; color: #28a745; font-weight: bold; margin-bottom: 10px; }
        ...
        .btn-view { display: block; text-align: center; padding: 10px; background: #f8f9fa; color: #007bff; border: 1px solid #007bff; text-decoration: none; border-radius: 4px; font-weight: bold; margin-top: auto; }
                ...
                <?php foreach ($latest_posts as $post): ?>
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/post/<?= $post['id'] ?>" class="btn-view" style="border-color: #28a745; color: #28a745;">Read Post</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>
