<header style="display: flex; align-items: center; padding: 15px 5%; border-bottom: 1px solid #0C4440; background: #032F2E; box-shadow: 0 2px 5px rgba(0,0,0,0.15); justify-content: space-between; flex-wrap: wrap; gap: 10px;">
    <a href="/" style="display: flex; align-items: center; text-decoration: none; color: inherit;">
        <img src="/logo.png" alt="Logo" style="width: 40px; margin-right: 10px;">
        <h1 style="margin: 0; font-size: 1.5rem; color: #D4AF37;">SYK Services</h1>
    </a>
